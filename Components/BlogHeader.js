  ...
  return (
    ...
    >
      <div className="cursor-pointer group px-6 py-6 md:px-10 md:w-1/3 flex flex-col items-start rounded transform">
        <span className="inline-block py-1 px-2 rounded bg-gray-100 dark:bg-amber-900 text-amber-700 dark:text-gray-200 text-sm font-medium tracking-widest">
          {data.Tags.split(" ")[0]}
        </span>
        <h2 className="sm:text-2xl text-xl title-font font-semibold text-gray-700 mt-4 mb-4 dark:text-gray-100 group-hover:text-amber-800 dark:group-hover:text-amber-400">
          {data.Title}
        </h2>
        ...
        <div className="flex items-center flex-wrap pb-2 border-b-2 border-gray-300 mt-auto w-full justify-between dark:border-amber-400">
          ...
          <a className="inline-flex items-center">
            <span className="flex-grow flex flex-col pl-4">
              <span className="text-gray-900 text-xs tracking-widest mt-0.5 dark:text-amber-300">
                {readTime}
              </span>
            </span>
          </a>
